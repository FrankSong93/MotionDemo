...
@interface EffectViewController () <MotionEffectViewDelegate, FINCameraDelagate, AVCaptureVideoDataOutputSampleBufferDelegate>
...
- (void)viewDidLoad {
	...
	_effectView = [[MotionEffectView alloc] initWithFrame:CGRectMake(0, 0, imageViewSize.width, imageViewSize.height)];
