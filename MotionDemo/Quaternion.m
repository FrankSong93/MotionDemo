...
{
	return [[Quaternion alloc] initWithRe:Re i:I j:J k:K];
}
...
+ (id)quaternionWithRandomDirection
{
	...
	return [[Quaternion alloc] initWithRandomDirection];
}
...
{
	return [[Quaternion alloc] initWithAngle:angle i:I j:J k:K];
}
